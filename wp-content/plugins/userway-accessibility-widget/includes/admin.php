...
function usw_userway_settings_page(){
    ...
    <?php if(!empty($all_options['code'])): ?>
        <div class="userway_code">
            <p>Your plugin was successfully registered. Your unique code UserWay: <strong><?= $all_options['code']; ?></strong></p>
        </div>
    <?php endif; ?>

    <?php if(empty($all_options['code'])): ?>
        <div class="userway_code">
            <p>You should configure plugin to continue your work.</p>
        </div>
    <?php endif; ?>
    ...
    <div id="instr">
        ...
        <ol>
            ...
            <li>Enter URL of your website</li>
            <li>Click on the button under the form to save changes</li>
            <li>Get your unique code Userway under the button</li>
        </ol>
        <strong>For individual settings, you should go to the widget's "Manage" menu</strong>
    </div>
